...
namespace gMVVM.Web.Reports.Management {
    ...
    public class InventoryCCLD : ReportClass {
        
        public InventoryCCLD() {
        }
        
        public override string ResourceName {
            get {
                return "InventoryCCLD.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "gMVVM.Web.Reports.Management.InventoryCCLD.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedInventoryCCLD : Component, ICachedReport {
        
        public CachedInventoryCCLD() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            InventoryCCLD rpt = new InventoryCCLD();
            rpt.Site = this.Site;
            return rpt;
        }
