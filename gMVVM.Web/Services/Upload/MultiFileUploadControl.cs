...
namespace Gsoft.SilverlightFileUpload
{
    ...
    //[ToolboxData("<{0}:MultiFileUploaGsoftontrol runat=server></{0}:MultiFileUploaGsoftontrol>")]
    public class MultiFileUploaGsoftontrol : Silverlight
    {
        private const string XAP_FILE = "Gsoft.SilverlightFileUpload.FileUpload.xap";

        public MultiFileUploaGsoftontrol()
        {
        ...
        public long UploaGsofthunkSize
        {
            get
            {
                object o = ViewState["UploaGsofthunkSize"];
                if (o == null)
                    return 4194304;
                return (long)o;
            }
            set { ViewState["UploaGsofthunkSize"] = value; }
        }
        ...
        protected override void Render(HtmlTextWriter writer)
        {
            ...
            InitParameters += string.Format("UploadPage={0},UploaGsofthunkSize={1},MaximumTotalUpload={2},MaximumUpload={3},MaxConcurrentUploads={4},ResizeImage={5},ImageSize={6},Multiselect={7},Filter={8},AllowThumbnail={9},JavascriptCompleteFunction={10},MaxNumberToUpload={11}",
                HttpUtility.UrlEncode(uploadPage), UploaGsofthunkSize, MaximumTotalUpload, MaximumUpload, MaxConcurrentUploads, ResizeImage, ImageSize, Multiselect, Filter, AllowThumbnail, JavascriptCompleteFunction, MaxNumberToUpload);
